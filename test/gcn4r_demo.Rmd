...
vis.motif(motif.graphs,61L,cl,threshold=0.4)
vis.motif(motif.graphs,8L,cl,threshold=0.4)
vis.motif(motif.graphs,5L,cl,threshold=0.5, weight.scaling.factor=1.5)
vis.motif(motif.graphs,71L,cl,threshold=0.2)
```
...
py <- import_builtins()
animation<-pandas$read_pickle("animation.pkl")
animation # finish t
```
